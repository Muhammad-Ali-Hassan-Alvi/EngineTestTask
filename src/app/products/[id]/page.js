...
export default function ProductDetail({ params }) {
  ...
  const product = {
    ...
    color: "Navy",
    images: [
      "https://cdn.shopify.com/s/files/1/0554/9086/1383/files/ENGINE-MEN-1.jpg?v=1729930000",
      "https://cdn.shopify.com/s/files/1/0554/9086/1383/files/ENGINE-MEN-2.jpg?v=1729930000",
      "https://cdn.shopify.com/s/files/1/0554/9086/1383/files/ENGINE-MEN-3.jpg?v=1729930000",
      "https://cdn.shopify.com/s/files/1/0554/9086/1383/files/ENGINE-MEN-4.jpg?v=1729930000",
    ],
  };
    ...
    <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="text-sm text-gray-600">Fabric: Cotton</div>
            <div className="mt-2 text-sm">Color: <span className="font-medium">{product.color}</span></div>
          </div>
          ...
          <div className="divide-y">
            ...
            <details className="py-4"><summary className="cursor-pointer font-medium">Product Description</summary><div className="pt-2 text-sm text-gray-600">A clean product description area for details.</div></details>
